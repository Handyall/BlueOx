...
static iomux_v3_cfg_t const enet_pads[] = {
	...
	/* AR8031 PHY Reset */
	MX6_PAD_ENET_CRS_DV__GPIO1_IO25		| MUX_PAD_CTRL(GPIO_PAD_CTRL_PD),
};
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	MX6_PAD_SD2_CLK__SD2_CLK	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_SD2_CMD__SD2_CMD	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_SD2_DAT0__SD2_DATA0	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_SD2_DAT1__SD2_DATA1	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_SD2_DAT2__SD2_DATA2	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_SD2_DAT3__SD2_DATA3	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_NANDF_D4__SD2_DATA4	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_NANDF_D5__SD2_DATA5	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_NANDF_D6__SD2_DATA6	| MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_NANDF_D7__SD2_DATA7	| MUX_PAD_CTRL(NO_PAD_CTRL),
...
static iomux_v3_cfg_t const ecspi1_pads[] = {
	MX6_PAD_KEY_COL0__ECSPI1_SCLK | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_KEY_COL1__ECSPI1_MISO | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_KEY_ROW0__ECSPI1_MOSI | MUX_PAD_CTRL(NO_PAD_CTRL),
...
static iomux_v3_cfg_t const usb_otg_pads[] = {
    /* BlueOx: USB_OTG_ID on GPIO_1, not ENET_RX_ER */
	MX6_PAD_EIM_D22__USB_OTG_PWR | MUX_PAD_CTRL(GPIO_PAD_CTRL_PD),
	MX6_PAD_ENET_RX_ER__USB_OTG_ID | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_GPIO_1__USB_OTG_ID | MUX_PAD_CTRL(GPIO_PAD_CTRL_PU),
};
...
int board_ehci_power(int port, int on)
{
	...
	case 0:
		break;
	case 1:
	    /* BlueOx: GPIO1_29 was for ENET_TXD1 = USB_H1_PWR_EN.
	       This is always on, so ignore. */
		break;
	default:
...
static const struct boot_mode board_boot_modes[] = {
    /* BlueOx: Only sd3, emmc are bootable; both are 8 bits */
	/* 8 bit bus width */
...
int checkboard(void)
{
	puts("Board: iMX6 on custom BlueOx\n");
	return 0;
}
